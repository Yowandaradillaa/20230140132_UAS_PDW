    ...
    <aside class="w-64 bg-gray-800 text-white flex flex-col">
        ...
        <nav class="flex-grow">
            <ul class="space-y-2 p-4">
                ...
                <li>
    <a href="kelola_pengguna.php" class="<?php echo ($activePage == 'kelola_pengguna') ? $activeClass : $inactiveClass; ?> flex items-center px-4 py-3 rounded-md transition-colors duration-200">
        <svg class="w-5 h-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.5 19.5a7.5 7.5 0 0115 0v.75a.75.75 0 01-.75.75h-13.5a.75.75 0 01-.75-.75V19.5z" />
        </svg>
        <span>Kelola Akun Pengguna</span>
    </a>
</li>
<li>
    <a href="matapraktikum.php" class="<?php echo ($activePage == 'tugas') ? $activeClass : $inactiveClass; ?> flex items-center px-4 py-3 rounded-md transition-colors duration-200">
        <svg class="w-5 h-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
